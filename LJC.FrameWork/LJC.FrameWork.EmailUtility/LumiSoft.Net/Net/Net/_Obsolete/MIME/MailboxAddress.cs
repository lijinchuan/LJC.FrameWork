	...
	public class MailboxAddress :  Address
	{
		...
		public static MailboxAddress Parse(string mailbox)
		{
			...
			/* We must parse following situations:
				"Ivar Lumi" <ivar@LJC.FrameWork.ee>
				"Ivar Lumi" ivar@LJC.FrameWork.ee
				<ivar@LJC.FrameWork.ee>
				ivar@LJC.FrameWork.ee				
				Ivar Lumi <ivar@LJC.FrameWork.ee>
			*/
		...
		/// For example, "Ivar Lumi" &lt;ivar@LJC.FrameWork.ee&gt;.
		...
		/// <summary>
		/// Gets or sets email address. For example ivar@LJC.FrameWork.ee.
		/// </summary>
		...
		/// <summary>
		/// Gets local-part from email address. For example mailbox is "ivar" from "ivar@LJC.FrameWork.ee".
		/// </summary>
		...
		/// <summary>
		/// Gets domain from email address. For example domain is "LJC.FrameWork.ee" from "ivar@LJC.FrameWork.ee".
		/// </summary>

...
namespace LJC.FrameWork.Data.EntityDataBase
{
    partial class BigEntityTableEngine
    {
        ...
        public void MergeKey2(string tablename, string indexname, EntityTableMeta meta)
        {
            ...
            try
            {
                ...
                using (var reader = ObjTextReader.CreateReader(indexfile))
                {
                    ...
                    if (copystart > 0)
                    {
                        ...
                        newdiskindexlist.AddRange(keyindexdisklist[tablename].Where(p => p.KeyOffset < copystart));
                    }

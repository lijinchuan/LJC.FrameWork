...
namespace Test2
{
    public class Fun1:IFun
    {
        ...
        {
            long total = 0;
            var list = BigEntityTableEngine.LocalEngine.Scan2<GubaBandResultEntity>("GubaBandResultEntity", "GubaCode_Uid_Recount", new object[] { "000001", "", 0 }, new object[] { "000002", "", 0 },266,13,ref total).ToList();

...
namespace Test
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            LJC.FrameWork.SocketApplication.SocketEasyUDP.Server.SessionServer serverbase = new LJC.FrameWork.SocketApplication.SocketEasyUDP.Server.SessionServer(50000);

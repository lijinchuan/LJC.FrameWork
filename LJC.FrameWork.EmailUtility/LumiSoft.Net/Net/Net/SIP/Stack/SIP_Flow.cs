...
using LJC.FrameWork.Net.UDP;
using LJC.FrameWork.Net.SIP.Message;

namespace LJC.FrameWork.Net.SIP.Stack
{
    /// <summary>
        ...
        {   
            try{
                ...
                // We have SIP message header.
                    ...
                    string contentLengthValue = LJC.FrameWork.Net.MIME.MIME_Utils.ParseHeaderField("Content-Length:",m_pMessage);

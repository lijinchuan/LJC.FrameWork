...
namespace LJC.FrameWork.Net.SMTP.Server
{
    /// <summary>
...
// REMOVE ME:
        ...
        private byte[] CreateReceivedHeader()
        {
            ...
            */
            ...
            LJC.FrameWork.Net.Mail.Mail_h_Received received = new LJC.FrameWork.Net.Mail.Mail_h_Received(this.EhloHost,Net_Utils.GetLocalHostName(this.LocalHostName),DateTime.Now);
            received.From_TcpInfo = new LJC.FrameWork.Net.Mail.Mail_t_TcpInfo(this.RemoteEndPoint.Address,null);
            received.Via = "TCP";

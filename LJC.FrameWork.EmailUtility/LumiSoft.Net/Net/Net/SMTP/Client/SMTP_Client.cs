...
using LJC.FrameWork.Net.IO;
using LJC.FrameWork.Net.TCP;
using LJC.FrameWork.Net.AUTH;
using LJC.FrameWork.Net.DNS;
using LJC.FrameWork.Net.DNS.Client;
using LJC.FrameWork.Net.Mail;
using LJC.FrameWork.Net.MIME;
using LJC.FrameWork.Net.Mime;

namespace LJC.FrameWork.Net.SMTP.Client
{
    /// <summary>
    ...
    /// // you can use LJC.FrameWork.Net.Mail classes to compose valid SMTP mail message.
    /// 
    ...
    public class SMTP_Client : TCP_Client
    {
                ...
                try{
                    /* RFC 5321 4.1.1.2. MAIL
			           ...
			           RFC 1870 adds optional SIZE keyword support.
			 	        ...
			 	        Examples:
			 		        MAIL FROM:<ivx@LJC.FrameWork.ee> SIZE=1000
        ...
        public static void QuickSend(LJC.FrameWork.Net.Mime.Mime message)
        {
            if(message == null){

...
namespace LJC.FrameWork.Net.RTP
{
    /// <summary>
    ...
    public class RTP_MultimediaSession : IDisposable
    {
        ...
        /// Default constructor.
        /// </summary>
        /// <param name="cname">Canonical name of participant. <seealso cref="LJC.FrameWork.Net.RTP.RTP_Utils.GenerateCNAME"/>RTP_Utils.GenerateCNAME 

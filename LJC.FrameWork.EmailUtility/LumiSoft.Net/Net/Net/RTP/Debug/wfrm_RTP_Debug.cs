...
using LJC.FrameWork.Net.Media.Codec;
using LJC.FrameWork.Net.RTP;

namespace LJC.FrameWork.Net.RTP.Debug
{
    /// <summary>
    ...
    public class wfrm_RTP_Debug : Form
    {
        ...
        public wfrm_RTP_Debug(RTP_MultimediaSession session)
        {
            ...
            m_pSession.Error += new EventHandler<LJC.FrameWork.Net.ExceptionEventArgs>(m_pSession_Error);
            m_pSession.SessionCreated += new EventHandler<LJC.FrameWork.Net.EventArgs<RTP_Session>>(m_pSession_SessionCreated);
        ...
        private void m_pSession_Error(object sender,LJC.FrameWork.Net.ExceptionEventArgs e)
        {
            if(m_IsDisposed){
                return;
            }
